...
if($do=='saveemail'){
	if(empty($email)){
        ...
        $rs = $db->get_one("select m_login from {$cfg['tb_pre']}member where m_email='$email' and m_login!='$login' limit 0,1");
	       if($rs){
	           showmsg('新邮箱地址已被占用，请重新输入！',"-1",0,2000);exit();
                ...
                showmsg('邮箱修改成功!',"?mpage=company_email&show=$show",0,2000);exit();
	       }
	}
}
...
<div class="memrightl">
    ...
    <div class="memrightbox">
    	...
    	<div class="con">
        <form method="post" name="addform" id="addform" action="?do=saveemail&mpage=company_email&show=<?php echo $show;?>">
        <ul>
            ...
            1、请填写有效的E-mail地址</li>
            <li class="l"></li>
            <li class="r"><input name="sendmail" type="checkbox" value="1" checked="checked" />接受来自本站的消息邮件 。</li>
        </ul>
        <ul>
            <li class="l"></li>
